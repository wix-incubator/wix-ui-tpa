...
export const overlappingCardTestkitFactory = protractorUniTestkitFactoryCreator(
...
export const avatarGroupTestkitFactory = protractorUniTestkitFactoryCreator(
  avatarGroupDriverFactory,
);
