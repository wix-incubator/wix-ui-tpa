...
export const avatarGroupTestkitFactory = protractorUniTestkitFactoryCreator(avatarGroupDriverFactory)

import { badgeDriverFactory } from '../components/Badge/Badge.driver';
export const badgeTestkitFactory = protractorUniTestkitFactoryCreator(badgeDriverFactory)
