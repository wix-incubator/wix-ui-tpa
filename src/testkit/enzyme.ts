...
export const iconButtonTestkitFactory: (
  obj: WrapperData,
) => any = enzymeUniTestkitFactoryCreator(iconButtonDriverFactory);
...
export const badgeTestkitFactory: (
  obj: WrapperData,
) => any = enzymeUniTestkitFactoryCreator(badgeDriverFactory);
