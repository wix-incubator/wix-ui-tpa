...
import extendedStyles from './StackedCardExtendedExample.st.css';
      ...
      media={
        <div
          style={{
            height: '100%',
            backgroundImage:
              'url("https://static.wixstatic.com/media/dd7e03deffdd4267b75ef0a60d8510c7.jpg/v1/fill/w_782,h_518,al_c,q_80,usm_0.66_1.00_0.01/Gift%20Wrapped.jpg")',
