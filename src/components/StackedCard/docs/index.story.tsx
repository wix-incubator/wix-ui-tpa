...
const mediaExamples = [
  {
    ...
    value: (
      <div
        style={{
          background:
            'url("https://static.wixstatic.com/media/dd7e03deffdd4267b75ef0a60d8510c7.jpg/v1/fill/w_782,h_518,al_c,q_80,usm_0.66_1.00_0.01/Gift%20Wrapped.jpg") no-repeat center center',
          height: '100%',
...
export default {
  ...
  storyName: 'StackedCard',
  component: StackedCard,
  componentPath: '../StackedCard.tsx',
  componentProps: () => ({
    media: mediaExamples[0].value,
    info: infoExample,
    'data-hook': 'storybook-StackedCard',
  }),
  exampleProps: {
    media: mediaExamples,
    ratio: Object.keys(StackedCardRatioOptions).map(
      key => StackedCardRatioOptions[key],
    ),
  },
  examples: <Examples />,
};
