...
export interface AnonymousProps extends React.SVGAttributes<SVGElement> {
size?: string;
}
export const Anonymous: React.SFC<AnonymousProps> = ({size, ...props}) => (
