  ...
  return (
    <>
      ...
      <div>
        ...
        <Dropdown className={classes.root} placeholder="This is placeholder" options={optionsWithSections} />
      </div>
      ...
      <div>
        ...
        <Dropdown className={classes.root} initialSelectedId='0' disabled options={optionsWithSections} />
      </div>
    </>
  );
};
