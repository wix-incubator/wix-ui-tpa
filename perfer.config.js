const files = [
  ...
  ['ActionsMenuLayout.perf.basic.bundle.min.js', 6],
  ['ActionsMenuLayout.perf.extended.bundle.min.js', 6],
  ...
  ['Button.perf.basic.bundle.min.js', 9],
  ['Button.perf.extended.bundle.min.js', 9],
